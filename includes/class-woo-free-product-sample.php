...
class Woo_Free_Product_Sample {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'woocommerce_after_add_to_cart_button', $plugin_public, 'woo_free_product_sample_sample_button', 5 );	
		...
		$this->loader->add_filter( 'woocommerce_update_cart_validation', $plugin_public, 'woo_free_product_sample_cart_update_limit_order', 10, 4 );
